...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%u successful, %lu skipped, timeElasped %.2f)", total - self.skippedCount, (unsigned long)self.skippedCount, CFAbsoluteTimeGetCurrent() - self.startedTime);
}
